...
| TASK-015 | Orders page — needs an admin orders endpoint (backend dependency) | In Progress | Agent | P2 |
| TASK-016 | Sellers page — needs an admin sellers endpoint (backend dependency) | In Progress | Agent | P2 |
| TASK-017 | Listings page — needs an admin listings endpoint (backend dependency) | In Progress | Agent | P2 |
